        ...
        if email_obj.email is not None:
            ...
            if args['account'] or args['key'] or args['small_business_key'] or args['vpn_codes']:
                ...
                if args['key'] or args['small_business_key'] or args['vpn_codes']:
                    ...
                    license_out_date = datetime.datetime.strptime(license_out_date, '%m/%d/%Y').strftime('%d/%m/%Y')
                    output_line = '\n'.join([
                        '',
                        '-------------------------------------------------',
                        f'Account Email: {email_obj.email}',
                    ...
                    if args['vpn_codes']:
                        ...
                        if not args['custom_email_api']:
                            ...
                            bot.send_message(-1002475137672, output_line + please_comment + "[⚡️Boost\!](https://t\.me/boost/esetnod32keyzz)", disable_web_page_preview=True, disable_notification=True)
            # ESET ProtectHub
